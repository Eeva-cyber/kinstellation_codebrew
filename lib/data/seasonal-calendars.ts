...
export const genericCalendar: SeasonalCalendar = {
  ...
  cycleType: 'circular',
  sourceAttribution:
    'A six-season ecological framework based on broadly shared Aboriginal seasonal knowledge. Seasons vary by Country — select your specific region for accurate seasonal knowledge.',
  seasons: [
    {
      id: 'fire_season',
      name: 'Fire Season',
      ...
      approximateMonths: [12, 1],
      description:
        'The hottest and driest time. Traditional fire management shapes the land — burning clears undergrowth, drives game, and encourages new growth. Long days and intense sun.',
      colorPalette: { bgFrom: '#1a0f05', bgTo: '#0d0a14', accentColor: '#e07830' },
      cyclePosition: 0,
    },
    {
      id: 'rain_season',
      name: 'Rain Season',
      nameEnglish: 'Rain and flood',
      approximateMonths: [2, 3],
      description:
        'Rain arrives and rivers flood. Billabongs fill with fish. A time of abundance — waterbirds nest, frogs call, and Country renews itself. Travel is limited but food is plentiful.',
      colorPalette: { bgFrom: '#081418', bgTo: '#06080e', accentColor: '#4a8aaa' },
      cyclePosition: 0.167,
    },
    {
      id: 'harvest_season',
      name: 'Harvest Season',
      nameEnglish: 'Cooling and harvest',
      approximateMonths: [4, 5],
      description:
        'The land cools. Seeds, fruits, and roots are gathered and stored. Animals are fat and hunting is good. A time for travel, trade, and gathering between groups.',
      colorPalette: { bgFrom: '#14100a', bgTo: '#0a0814', accentColor: '#c4a35a' },
      cyclePosition: 0.333,
    },
    {
      id: 'cold_season',
      name: 'Cold Season',
      nameEnglish: 'Cold and still',
      approximateMonths: [6, 7],
      description:
        'The cold and dry season. Time to shelter close to camp, share stories, and pass on knowledge. The night sky is clear and brilliant — a time for ceremony and star knowledge.',
      colorPalette: { bgFrom: '#080a1a', bgTo: '#060818', accentColor: '#6b84c8' },
      cyclePosition: 0.5,
    },
    {
      id: 'flower_season',
      name: 'Flower Season',
      nameEnglish: 'Warming and bloom',
      approximateMonths: [8, 9],
      description:
        'The land warms. Wildflowers emerge and signal that certain foods are ready. Baby animals are born. Birds begin to nest. The world is renewing — a sacred and joyful time.',
      colorPalette: { bgFrom: '#0d1208', bgTo: '#080a14', accentColor: '#8db86b' },
      cyclePosition: 0.667,
    },
    {
      id: 'storm_season',
      name: 'Storm Season',
      nameEnglish: 'Buildup and storms',
      approximateMonths: [10, 11],
      description:
        'Heat and humidity build before the rains. Thunder and lightning mark the sky. Animals and plants prepare for the wet. An electric, powerful time of change on Country.',
      colorPalette: { bgFrom: '#10100a', bgTo: '#0a0814', accentColor: '#c89a38' },
      cyclePosition: 0.833,
    },
  ],
};
